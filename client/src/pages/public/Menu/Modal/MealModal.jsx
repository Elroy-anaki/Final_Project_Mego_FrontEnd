...
function MealModal() {
    ...
    return (
        <div>
            <dialog
                id="mealDatails"
                className="modal bg-white shadow-2xl rounded-lg overflow-hidden border-0 w-[70%] max-w-4xl mx-auto"
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                    <div className="shrink-0 max-w-md lg:max-w-xl mx-auto flex justify-center">
                        <img
                            className="w-80 h-80 lg:w-96 lg:h-96 rounded-xl object-cover shadow-md"
                            src={meal?.mealImage}
                            alt={meal?.mealName}
                        />
                    </div>
